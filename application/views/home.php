...
<section class="main-info">
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span3">
                <a class="btn btn-success btn-large pull-right" href="#">Free Download Nova</a>
            </div>
        </div>
    </div>
</section>
...
<section id="recent-works">
    <div class="container">
        ...
        <ul class="gallery col-4">
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url('images/portfolio/thumb/item1.jpg'); ?>">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-1" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="<?php echo base_url('images/portfolio/full/item1.jpg'); ?>" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>
            </li>
            <!--/Item 1-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url('images/portfolio/thumb/item2.jpg'); ?>">
                    <div class="overlay">
                    </div>
                    <div class="links">
                        <a data-toggle="modal" href="#modal-1"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a>
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url('images/portfolio/full/item2.jpg'); ?>" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>
            </li>
            <!--/Item 2-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url('images/portfolio/thumb/item3.jpg'); ?>">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url('images/portfolio/full/item3.jpg'); ?>" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>
            </li>
            <!--/Item 3-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url('images/portfolio/thumb/item4.jpg'); ?>">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url('images/portfolio/full/item4.jpg'); ?>" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>
            </li>
            <!--/Item 4-->
                ...
                <div id="myCarousel" class="carousel slide clients">
                  ...
                  <div class="carousel-inner">
                    <div class="active item">
                        <div class="row-fluid">
                            <ul class="thumbnails">
                                <li class="span3"><a href="#"><img src="<?php echo base_url('images/sample/clients/client1.png'); ?>"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url('images/sample/clients/client2.png'); ?>"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url('images/sample/clients/client3.png'); ?>"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url('images/sample/clients/client4.png'); ?>"></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <div class="row-fluid first">
                    <ul class="thumbnails">
                      <li class="span3">
                        <a href="#" title="01 (254) by Victor1558, on Flickr"><img src="<?php echo base_url('images/6829540293_bd99363818_s.jpg'); ?>" width="75" height="75" alt="01 (254)"></a>
                    </li>
                    <li class="span3">
                        <a href="#" title="01 (196) by Victor1558, on Flickr"><img src="<?php echo base_url('images/6829537417_465d28e1db_s.jpg'); ?>" width="75" height="75" alt="01 (196)"></a>
                    </li>
                    <li class="span3">
                        <a href="#" title="01 (65) by Victor1558, on Flickr"><img src="<?php echo base_url('images/6829527437_88364c7ec4_s.jpg'); ?>" width="75" height="75" alt="01 (65)"></a>
                    </li>
                    <li class="span3">
                        <a href="#" title="01 (6) by Victor1558, on Flickr"><img src="<?php echo base_url('images/6829524451_a725793358_s.jpg'); ?>" width="75" height="75" alt="01 (6)"></a>
                    </li>
                </ul>
            </div>
            <div class="row-fluid">
