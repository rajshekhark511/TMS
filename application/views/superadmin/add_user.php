                ...
                <div class="col-lg-12">
                    <div class="box dark">
                        ...
                        <div id="div-1" class="accordion-body body in" style="height: auto;">
                            ...
                            <form role="form" method="post" action="" name="frmUser" id="frmUser" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="institute_id" id="institute_id">
                                                ...
                                                <?php foreach ($institute as $iKey => $iVal) { ?>
                                                    <option value="<?php echo $iVal['inst_id']; ?>" <?php echo ((set_select('institute_id',(isset($user['institute_id']) ? $user['institute_id'] : '')) == $iVal['inst_id']) ? $$iVal['inst_id'] : ''); ?> <?php echo set_select('institute_id'); echo ((isset($user['institute_id']) && $iVal['inst_id']==$user['institute_id']) ? 'selected' : '')?>><?php echo $iVal['inst_name'] ?></option>
                                                <?php }  ?>
                                            </select>
                                            <?php echo form_error('institute_id', '<div class="text-danger">', '</div>'); ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
