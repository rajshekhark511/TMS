            ...
            <div class="container">
                <div class="main row">
                    <div class="col-md-6 content_left">
                        <img src="<?php echo base_url('images/pic1.jpg'); ?>" alt="" class="img-responsive">
                    </div>
                ...
                <div id="owl-demo" class="owl-carousel text-center">
                    <div class="item">
                        <div class="cau_left">
                            <img class="lazyOwl" data-src="<?php echo base_url('images/c1.jpg'); ?>" alt="Lazy Owl Image">
                        </div>
                        <div class="cau_left">
                    ...
                    <div class="item">
                        <div class="cau_left">
                            <img class="lazyOwl" data-src="<?php echo base_url('images/c2.jpg'); ?>" alt="Lazy Owl Image">
                        </div>
                        <div class="cau_left">
                    ...
                    <div class="item">
                        <div class="cau_left">
                            <img class="lazyOwl" data-src="<?php echo base_url('images/c3.jpg'); ?>" alt="Lazy Owl Image">
                        </div>
                        <div class="cau_left">
                    ...
                    <div class="item">
                        <div class="cau_left">
                            <img class="lazyOwl" data-src="<?php echo base_url('images/c4.jpg'); ?>" alt="Lazy Owl Image">
                        </div>
                        <div class="cau_left">
